...
int Data::aktualnyDzien(){
    time_t t = time(0);
    tm *teraz = localtime(&t);
    return teraz->tm_mday;
}
int Data::aktualnyMiesiac(){
    time_t t = time(0);
    tm *teraz = localtime(&t);
    return teraz->tm_mon + 1;
}
int Data::aktualnyRok(){
    time_t t = time(0);
    tm *teraz = localtime(&t);
    return teraz->tm_year + 1900;
}
Data::Data(): dzien(aktualnyDzien()),miesiac(aktualnyMiesiac()),rok(aktualnyRok()){
